...
class BuiltinPerspectives {
  ...
  static const int version = 3;  // 2026-01-08: 新增书单推荐视角
...
语气要有启发性，用具体案例说透道理，避免空洞说教。''',
  ...
  /// 📚 书单推荐
  static PerspectiveEntity _createBookRecommendation() {
    return PerspectiveEntity.create(
      perspectiveId: 'builtin_book_recommendation',
      name: '书单推荐',
      icon: '📚',
      description: '从你关心的问题出发，用四象限法推荐最值得读的书',
      category: categoryReview,
      isBuiltin: true,
      isEnabled: true,
      sortOrder: 16,
      promptTemplate: '''你是一位博览群书的阅读顾问。请仔细分析以下用户最近提出的问题和关心的话题，推断ta当前面临的挑战和需求，然后用艾森豪威尔四象限法推荐一份个性化书单。
...
用第二人称"你"来表述，语气像一位懂你的朋友在推荐好书。推荐的书籍要真实存在，不要编造书名。''',
    );
  }
